...
import (
	factories "github.com/douglasdennys/go-mongodb/src/main/factories/controllers"
	usecases "github.com/douglasdennys/go-mongodb/src/main/factories/usecases/user/add-user"
